...
class SimpleStorageService:
    ...
    def s3_key_path_available(self, bucket_name, s3_key) -> bool:
        ...
        try:
            ...
            raise MyException(e, sys) # type: ignore[return-value]
    ...
    def read_object(object_name: str, decode: bool = True, make_readable: bool = False) -> Union[StringIO, str]:
        ...
        try:
            ...
            func = (
                lambda: object_name.get()["Body"].read().decode() # type: ignore[no-any-return]
                if decode else object_name.get()["Body"].read() # type: ignore[no-any-return]
            )
            ...
            raise MyException(e, sys) from e # type: ignore[return-value]
    ...
    def get_bucket(self, bucket_name: str) -> Bucket:
        ...
        try:
            bucket = self.s3_resource.Bucket(bucket_name) # type: ignore[no-any-return]
    ...
    def load_model(self, model_name: str, bucket_name: str, model_dir: str = None) -> object: # type: ignore[no-any-return]
        """
        ...
        try:
            ...
            model_obj = self.read_object(file_object, decode=False) # type: ignore[no-any-return]
            model = pickle.loads(model_obj) # type: ignore[no-any-return]
    ...
    def create_folder(self, folder_name: str, bucket_name: str) -> None:
        ...
        try:
            ...
            self.s3_resource.Object(bucket_name, folder_name).load() # type: ignore[no-any-return]
        except ClientError as e:
            # If folder does not exist, create it
            if e.response["Error"]["Code"] == "404":
                folder_obj = folder_name + "/"
                self.s3_client.put_object(Bucket=bucket_name, Key=folder_obj) # type: ignore[no-any-return]
    ...
    def upload_file(self, from_filename: str, to_filename: str, bucket_name: str, remove: bool = True):
        ...
        try:
            ...
            self.s3_resource.meta.client.upload_file(from_filename, bucket_name, to_filename) # type: ignore[no-any-return]
    ...
    def upload_df_as_csv(self, data_frame: DataFrame, local_filename: str, bucket_filename: str, bucket_name: str) -> None:
        ...
        try:
            ...
            data_frame.to_csv(local_filename, index=None, header=True) # type: ignore[no-any-return]
    ...
    def get_df_from_object(self, object_: object) -> DataFrame:
        ...
        try:
            content = self.read_object(object_, make_readable=True) # type: ignore[no-any-return]
